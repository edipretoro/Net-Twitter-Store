package Net::Twitter::Store::Schema;
...
Net::Twitter::Store::Schema - The great new Net::Twitter::Store::Schema!
...
Perhaps a little code snippet.
    ...
    my $foo = Net::Twitter::Store::Schema->new();
    ...
...
Please report any bugs or feature requests to C<bug-net-twitter-store-schema at rt.cpan.org>, or through
